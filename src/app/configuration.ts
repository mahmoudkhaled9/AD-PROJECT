...
export const configuration = {
    ...
    footer: {
        ...
        developer: 'Mahmoud Khaled',
        developerlink: 'https://mahmoudkhaled.neocities.org/',
    },
    socialsites: [
        {title: 'Facebook', target: '_blank', username: 'https://www.facebook.com/m7mood.khaled.9', icon: 'facebook'},
        {title: 'Google+', target: '_blank', username: '+m7mood.khaled.9', icon: 'google-plus'},
        {title: 'Twitter', target: '_blank', username: 'm7mood.khaled.9', icon: 'twitter'},
        {title: 'Instagram', target: '_blank', username: 'https://www.instagram.com/mahmoud__khaled9/', icon: 'instagram'},
        {title: 'Behance', target: '_blank', username: 'm7mood.khaled.9', icon: 'behance'},
    ],
    blog: {
        tagline: 'MY BLOG',
